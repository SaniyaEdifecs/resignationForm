...
const ResignationDetail = ({ props }) => {
  ...
  const { state, disable, setState, status, handleOnChange, handleOnSubmit } =
    resignationUseForm(stateSchema, validationStateSchema, onSubmitForm);
  ...
  const getEmployeeDetail = () => {
    ...
    SharePointService.getListByTitle("ItClearance")
    ...
    SharePointService.getListByTitle("ManagersClearance")
      .items.filter("EmployeeNameId eq " + ID)
      .get()
      .then(
        (items) => {
    ...
    SharePointService.getListByTitle("OperationsClearance")
      .items.filter("EmployeeNameId eq " + ID)
      .get()
      .then(
        (items) => {
    ...
    SharePointService.getListByTitle("Finance%20Clearance")
      .items.filter("EmployeeNameId eq " + ID)
      .get()
      .then(
        (items) => {
    ...
    SharePointService.getListByTitle("SalesForceClearance")
      .items.filter("EmployeeNameId eq " + ID)
      .get()
      .then(
        (items) => {
  ...
  return (
    <Paper className="root">
      ...
      {employeeDetail["HrStatus"] === "Approved" &&
      employeeDetail["FinanceStatus"] === "Approved" &&
      employeeDetail["ItStatus"] === "Approved" &&
      employeeDetail["ManagerStatus"] === "Approved" &&
      employeeDetail["emplStatus"] === "Approved" &&
      employeeDetail["Operations_x002f_AdminStatus"] === "Approved" &&
      employeeDetail["SalesforceStatus"] === "Approved" ? (
          ...
          <div className="clearanceTable">
                ...
                <tr>
                  ...
                  <td>
                    <Moment format="DD/MM/YYYY">
                      {employeeDetail["ResignationDate"]}
                    </Moment>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    {" "}
                    <Moment format="DD/MM/YYYY">
                      {employeeDetail["LastWorkingDate"]}
                    </Moment>
                  </td>
                </tr>
                <tr>
                  ...
                  <td colSpan={3} className="innerTable">
                    <table cellPadding="0" cellSpacing="0">
                      <tbody>
                        <tr>
                          <td>
                            Do you approve early relieving (short of notice
                            period)?
                          </td>
                          <td>
                            {managerClearance &&
                              managerClearance["NoticeWaiver"]}{" "}
                          </td>
                          <td>{managerClearance["NoticeWaiverComments"]}</td>
                        </tr>
                        <tr>
                          <td>
                            Do you approve the recovery amount, if any (after
                            adjustment of short fall of notice period with paid
                            leaves)?
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            {managerClearance["HandoverCompleteComments"]}
                          </td>
                        </tr>
                        <tr>
                          <td>Data Backup</td>
                        ...
                        <tr>
                          ...
                          <td>
                            {managerClearance["EmailRe_x002d_routingComments"]}{" "}
                          </td>
                        </tr>
                        <tr>
                          <td>Others(Specify)</td>
                          <td>
                            {managerClearance["Others_x0028_specify_x0029_"]}{" "}
                          </td>
                        ...
                        <tr>
                          ...
                          <td colSpan={2}>
                            {managerClearance["AdditionalInformation"]}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table cellPadding="0" cellSpacing="0">
                      <tbody>
                        ...
                        <tr>
                          <td>Additional Comments</td>
                          <td colSpan={2}>
                            {itDetail["AdditionalInformation"]}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                  ...
                  <td colSpan={3} className="innerTable">
                    <table cellPadding="0" cellSpacing="0">
                      <tbody>
                        <tr>
                          <td>
                            SDFC License termination: email to
                            Katie.loescher@edifecs.com
                          </td>
                          <td>
                            {salesForceClearance &&
                              salesForceClearance["LicenseTermination"]}{" "}
                          </td>
                          <td>
                            {salesForceClearance["LicenseTerminationComment"]}
                          </td>
                        </tr>
                        <tr>
                          {" "}
                          <td>Additional Comments</td>
                          <td colSpan={2}>
                            {salesForceClearance["AdditionalInformation"]}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table cellPadding="0" cellSpacing="0">
                      <tbody>
                        <tr>
                          ...
                          <td>
                            {operationsClearance &&
                              operationsClearance["PedestalKeys"]}{" "}
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            {operationsClearance["StationaryClearanceComments"]}{" "}
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>
                            {operationsClearance["KuoniConcurAccessComments"]}{" "}
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            {operationsClearance["BiometricAccessComments"]}{" "}
                          </td>
                        </tr>
                        <tr>
                          <td>Others (Specify)</td>
                        ...
                        <tr>
                          <td>Additional Comments</td>
                          <td colSpan={2}>
                            {operationsClearance["AdditionalInformation"]}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            {financeClearance &&
                              financeClearance[
                                "Loan_x002f_ImprestBalance"
                              ]}{" "}
                          </td>
                          <td>
                            {
                              financeClearance[
                                "Loan_x002f_ImprestBalanceComment"
                              ]
                            }
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            {financeClearance["TravelAdvance_x002f_Expenses"]}
                          </td>
                          <td>
                            {
                              financeClearance[
                        ...
                        <tr>
                          ...
                          <td>
                            {financeClearance["TelephoneReimbursementComments"]}{" "}
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            {financeClearance["InvestmentProofsComments"]}
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            {financeClearance["HouseRentReceiptsComments"]}{" "}
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td>Additional Comments</td>
                          <td colSpan={2}>
                            {financeClearance["AdditionalInformation"]}
                          </td>{" "}
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table cellPadding="0" cellSpacing="0">
                      <tbody>
                        <tr>
                          ...
                          <td>
                            {hrClearance &&
                              hrClearance["Resignationemailacceptance"]}{" "}
                          </td>
                          <td>
                            {hrClearance["ResignationAcceptancecomments"]}
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>
                            {hrClearance["Relocation_x002f_ReferralBonus"]}
                          </td>
                          <td>
                            {hrClearance["Relocation_x002f_ReferralBonusCo"]}{" "}
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td>
                            Terminate on Hr systems - ADP, Bamboo,
                            <br /> Org.Wizard, Jobvite, Savior
                          </td>
                          <td>{hrClearance["TerminateOnHRSystems"]}</td>
                          <td>
                            {hrClearance["TerminateOnHRSystemsComments"]}{" "}
                          </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td>Recovery on home office reimbursement program</td>
                          <td>{hrClearance["HomeAllowanceRecovery"]}</td>
                          <td>
                            {hrClearance["HomeAllowanceRecoveryComments"]}{" "}
                          </td>
                        </tr>
                        {/*   <tr>
                        ...
                        <tr>
                          <td>Additional Comments</td>
                          <td colSpan={2}>
                            {hrClearance["AdditionalInformation"]}
                          </td>
                        </tr>
                      </tbody>
                    </table>
            ...
            {readOnly ? (
              ...
              <form
                ...
                className="clearanceForm marginTop16"
              >
                <div>
                  <TextField
                    id="outlined-textarea"
                    required
                    className="width50 MuiFormControl-root MuiTextField-root MuiFormControl-marginNormal"
                    ...
                    value={state.FinalComments.value}
                  />
                  {state.FinalComments.error && (
                    <p style={errorStyle}>{state.FinalComments.error}</p>
                  )}
                </div>
                <Button
                  type="submit"
        ...
        <div className="formView">
          ...
          <Breadcrumbs separator="›" aria-label="breadcrumb">
            ...
            <Link
              color="inherit"
              onClick={() =>
                SharePointService.redirectTo(strings.ResigntionDashboard, "")
              }
            >
              Clearance Dashboard
            </Link>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    {managerClearance ? (
                      <td>
                        {managerClearance &&
                        managerClearance["Status"] != "Approved" ? (
                          <Link
                            onClick={() =>
                  ...
                  <tr>
                    ...
                    {salesForceClearance ? (
                      <td>
                        {salesForceClearance &&
                        salesForceClearance["Status"] != "Approved" ? (
                          <Link
                            onClick={() =>
                              SharePointService.redirectTo(
                                "salesForceClearance",
                                salesForceClearance["ID"]
                              )
                            }
                          >
                            {salesForceClearance["Status"]}
                          </Link>
                        ) : (
                          "Approved"
                        )}
                  ...
                  <tr>
                    ...
                    {financeClearance ? (
                      <td>
                        {financeClearance &&
                        financeClearance["Status"] != "Approved" ? (
                          <Link
                            onClick={() =>
                              SharePointService.redirectTo(
                                "financeClearance",
                  ...
                  <tr>
                    ...
                    {operationsClearance ? (
                      <td>
                        {operationsClearance &&
                        operationsClearance["Status"] != "Approved" ? (
                          <Link
                            onClick={() =>
                              SharePointService.redirectTo(
                                "operationsClearance",
                                operationsClearance["ID"]
                              )
                            }
                          >
                            {operationsClearance["Status"]}
                          </Link>
                        ) : (
                          "Approved"
                        )}
